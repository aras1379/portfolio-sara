...
export const mySkills: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { id: 'next-js', label: 'Next.js', proficiency: 35 },
      { id: 'typescript', label: 'TypeScript', proficiency: 35 },
      { id: 'tailwind-css', label: 'Tailwind CSS', proficiency: 40 },
      { id: 'swift', label: 'Swift', proficiency: 60 },
      { id: 'react-native', label: 'React Native', proficiency: 35 },
      { id: 'dart', label: 'Dart(Flutter)', proficiency: 45 },
    ],
  },
  {
    label: 'Backend',
    ...
    skills: [
      ...
      { id: 'c++', label: 'C++', proficiency: 30 },
      { id: 'typescript', label: 'TypeScript', proficiency: 35 },
      { id: 'javascript', label: 'JavaScript', proficiency: 40 },
      { id: 'next-js', label: 'Next.js', proficiency: 35 },
      { id: 'node-js', label: 'Node.js', proficiency: 40 },
      { id: 'websockets', label: 'WebSockets', proficiency: 45},
      { id: 'sql', label: 'SQLite', proficiency: 40 },
    ],
  },
  {
    label: 'Tools & DevOps',
    ...
    skills: [
      ...
      { id: 'ci/cd', label: 'CI/CD', proficiency: 30 },
    ],
  },
];
